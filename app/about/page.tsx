...
export default function(){
    return(
        ...
        <div className="main">
            ...
            <div className="about">
                <p>ABOUT US</p>
                <h1>CRAFTING DIGITAL DREAMS INTO REALITY</h1>
                <p>Welcome to Recognify, an award-winning digital agency dedicated to transforming visions into remarkable digital experiences. With a track record of success and a passion for innovation, we partner with businesses to create meaningful impact through beautifully designed and intelligently built solutions.</p>

<p>Our journey began with a simple mission: to elevate brands by delivering digital products that not only look exceptional but function seamlessly. Over the years, our commitment to excellence has been recognized with industry awards and the trust of leading brands. At Recognify, we believe in blending creativity with advanced technology, crafting bespoke solutions that drive results and resonate with users.</p>
